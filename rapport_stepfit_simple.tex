...
\hline
Marche lente (3 km/h) & 500 & 490 & 2\% \\
Marche normale (5 km/h) & 500 & 495 & 1\% \\
Marche rapide (7 km/h) & 500 & 493 & 1.4\% \\
Course légère (10 km/h) & 500 & 478 & 4.4\% \\
\hline
\textbf{Total} & \textbf{2000} & \textbf{1956} & \textbf{2.2\%} \\
\hline
\end{tabular}
\end{center}

\textbf{Précision globale: 97.8\%} (1956 pas détectés correctement sur 2000)

\textbf{Analyse des erreurs:}
\begin{itemize}
    \item Faux négatifs: 44 pas (2.2\%) - pas manqués en marche très lente
    \item Faux positifs: $<$5 détections parasites sur 2000 pas (négligeable)
    \item Meilleure précision: marche normale 5-6 km/h (plage optimale)
\end{itemize}
